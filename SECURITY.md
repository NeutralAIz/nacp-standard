...
If you find a security issue in the NACP specification, please open a GitHub Security Advisory on this repository or contact the maintainers via the address listed in the repository's contact information. Issues in specific implementations of NACP should be reported to the relevant implementation's own security contact.
